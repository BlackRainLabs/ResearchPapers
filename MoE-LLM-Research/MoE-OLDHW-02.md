...
![Speed Badge](https://img.shields.io/badge/Speed-8%E2%80%9316%20t%2Fs-orange?style=flat-square)
...
> **Real-World Result**: Stable 8–16 tokens/second at 16K context on a **GTX 1060 3GB** 🔥
...
This setup **requires a TurboQuant fork** of llama.cpp for the specialized KV cache types (`turbo2` / `turbo3`) and enhanced MoE handling.
...
**Made with ❤️ from Black Rain Labs for the local LLM community**  
